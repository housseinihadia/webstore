...
/*
** Get least categories 
** function to get least categories  from database  
...
/*
** Get  items 
** function to get least items  from database  
...
function getitems ($where, $value, $approve = NULL) {
	...
	if($approve == NULL) {
		...
		$sql = 'AND Approve = 1'; // this mean the items are activate 
...
/*
** this function check the user is activate or not by using Resstatus 
** and accrpted 1 parmater
*/
